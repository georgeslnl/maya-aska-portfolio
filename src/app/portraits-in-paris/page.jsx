...
import pip11 from '../images/portraits-in-paris/pip11.jpg';
import pip12 from '../images/portraits-in-paris/pip12.jpg';
...
const imageData = [
    ...
    { src: pip3, alt: "Portraits in Paris 3", span: 6 },
    // { src: pip2, alt: "Portraits in Paris 2", span: 12},
    ...
    { src: pip8, alt: "Portraits in Paris 8", span: 12 },
    { src: pip9, alt: "Portraits in Paris 9", span: 6 },
    { src: pip10, alt: "Portraits in Paris 10", span: 6 },
    { src: pip11, alt: "Portraits in Paris 11", span: 6 },
    { src: pip12, alt: "Portraits in Paris 12", span: 6 },
];
...
const PortraitsInParisPage = () => {
    return (
        <div className="w-11/12 lg:w-10/12 pb-10">
            ...
            <ImageGrid images={imageData.slice(0,5)} />
            <Credits credits={credits.slice(0,3)} />
            <ImageGrid images={imageData.slice(5)} />
